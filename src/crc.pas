...
{** @author(Carl Eric Codere) 
    @abstract(CRC generation unit)
    
    CRC generation routines, compatible
    with ISO 3309 and ITU-T-V42.
...
Function UpdateCrc32(InitCrc:longword;b: byte):longword;
begin
  InitCRC := longword(InitCRC shr 8) xor longword(crctable[byte(InitCRC) xor b]);
  UpdateCrc32:=InitCRC;
end;
